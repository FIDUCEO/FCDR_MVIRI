...
//    printf("I - inbuf: %d outbuf: %d count: %d\n",inbuf,outbuf,count);
...
// 	    printf("IIIb1 - inbuf: %d outbuf: %d count: %d\n",inbuf,outbuf,count);
            ...
            *out++ = ( vaxpart1 & SIGN_BIT ) |
                     ( ( HIDDEN_BIT | ( vaxpart1 & MANTISSA_MASK ) ) >>
                       ( 1 - e ) );
// 	    printf("IIIb2 - inbuf: %d outbuf: %d count: %d\n",inbuf,outbuf,count);
         }
...
//    printf("IV - inbuf: %d outbuf: %d count: %d\n",inbuf,outbuf,count);
